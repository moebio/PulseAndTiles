...
function Element(k, callBackSendData, config = {freeze_when_out:true}) {
	this.k = k
...
Element.prototype.setData = function(){
	this.k.cycleFor(100)
}

Element.prototype.setConfig = function(configObj){
	this.FREEZE_WHENOUT = configObj.freeze_when_out
}

Element.prototype.control = function(controlObj){
...
Element.prototype.setDimensions = function(x, y, w, h){
	this.x = x
	this.y = y
	this.w = w
	this.h = h
...
Element.prototype._drawFrozen = function(){
	this._checkCursor()
...
Element.prototype._checkCursor = function(){
