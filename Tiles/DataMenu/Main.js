const SCAN_DIR_PATH = "https://moebio.protozoo.com/scandir.php";
const CORS_PATH = "";// "https://cors-anywhere.herokuapp.com/";
const BASE_PATH = "https://moebio.protozoo.com/data/";
...
init=function(){
  ...
  GET(SCAN_DIR_PATH, function(scan){
    TREE = buildTree(scan, CORS_PATH, BASE_PATH); //without cors path, maybe it should be used fo files outside protozoo.moebio
    HTML = buildHtml(TREE);
    ...
    lastFile = (lastFile==null || lastFile=="null")?"https://moebio.protozoo.com/data/experiments/interesting/titanic.csv":lastFile;
