...
goToCoordinates = function(lat, lng, zoom, duration=0){
  console.log("goToCoordinates:", lat, lng, zoom)
  this.map.setView(new L.LatLng( lat , lng), zoom, {animate:true, duration});
}
